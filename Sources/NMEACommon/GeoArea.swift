...
public struct GeoArea: Sendable, Codable, Equatable {
  ...
  public init(
    latitude: Measurement<UnitAngle>, longitude: Measurement<UnitAngle>,
    deltaLat: Measurement<UnitAngle>, deltaLon: Measurement<UnitAngle>
  ) {
  ...
  public init(northeast: Position, southwest: Position) {
    ...
    self.init(
      latitude: southwest.latitude, longitude: southwest.longitude, deltaLat: deltaLat,
      deltaLon: deltaLon)
  }
}
