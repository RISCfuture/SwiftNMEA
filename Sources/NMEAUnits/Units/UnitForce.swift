...
public class UnitForce: Dimension, @unchecked Sendable {
  ...
  /// Kilonewtons (kN)
  public static let kilonewtons = UnitForce(
    symbol: "kN", converter: UnitConverterLinear(coefficient: 1000))

  /// Meganewtons (MN)
  public static let meganewtons = UnitForce(
    symbol: "MN", converter: UnitConverterLinear(coefficient: 1_000_000))

  /// Dynes (dyn): CGS unit of force
  public static let dynes = UnitForce(
    symbol: "dyn", converter: UnitConverterLinear(coefficient: 1 / 100_000.0))

  /// Pounds force (lbf): American standard unit of force
  public static let pounds: UnitForce = unit(
    UnitMass.pounds, times: UnitAcceleration.gravity, symbol: "lbf")

  /// Ounces force (ozf)
  public static let ounces: UnitForce = unit(
    UnitMass.ounces, times: UnitAcceleration.gravity, symbol: "ozf")

  /// Tons (short) force (tnf)
  public static let shortTons: UnitForce = unit(
    UnitMass.shortTons, times: UnitAcceleration.gravity, symbol: "tnf")

  /// Kiloponds (kp): kilogram force
  public static let kiloponds: UnitForce = unit(
    UnitMass.kilograms, times: UnitAcceleration.gravity, symbol: "kp")
