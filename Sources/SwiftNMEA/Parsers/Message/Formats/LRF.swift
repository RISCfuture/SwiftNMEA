...
class LRFParser: MessageFormat {
    ...
    func canParse(sentence: ParametricSentence) throws -> Bool {
        sentence.delimiter == .parametric && (
            ...
            sentence.format == .AISLongRangeReply1 || sentence.format == .AISLongRangeReply2 || sentence.format == .AISLongRangeReply3)
    }
    ...
    private func makePayload(recipient _: LRFRecipient, element: LRFElement) throws -> Message.Payload {
        try .AISLongRangeReply(requestorMMSI: element.MMSI,
    ...
    private struct LRFElement: BufferElement {
        ...
        var time: Date? {
            get throws {
                try sentences[.AISLongRangeReply2]?.fields.datetime(ymdIndex: 2,
                                                                    hmsDecimalIndex: 3,
                                                                    optional: true)
            }
        }
        ...
        var shipName: String? {
            get throws {
                guard let name = try sentences[.AISLongRangeReply1]?.fields.string(at: 3, optional: true) else {
                    return nil
                }
        ...
        var shipCallsign: String? {
            get throws {
                guard let callsign = try sentences[.AISLongRangeReply1]?.fields.string(at: 4, optional: true) else {
                    return nil
                }
        ...
        var position: Position? {
            get throws {
                try sentences[.AISLongRangeReply2]?.fields.position(latitudeIndex: (4, 5),
                                                                    longitudeIndex: (6, 7),
                                                                    optional: true)
            }
        }
        ...
        var course: Bearing? {
            get throws {
                try sentences[.AISLongRangeReply2]?.fields.bearing(at: 8,
                                                                   valueType: .float,
                                                                   referenceIndex: 9,
                                                                   optional: true)
            }
        ...
        var speed: Measurement<UnitSpeed>? {
            get throws {
                try sentences[.AISLongRangeReply2]?.fields.measurement(at: 10,
                                                                       valueType: .float,
                                                                       unitAt: 11,
                                                                       units: speedUnits,
                                                                       optional: true)
        ...
        var destination: String? {
            get throws {
                guard let dest = try sentences[.AISLongRangeReply3]?.fields.string(at: 2, optional: true) else {
                    return nil
                }
        ...
        var ETA: Date? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.datetime(ymdIndex: 3,
                                                                    hmsDecimalIndex: 4,
                                                                    optional: true)
            }
        }
        ...
        var shipType: AISLongRange.ShipType? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.enumeration(at: 6,
        ...
        var shipType2: AISLongRange.ShipType? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.enumeration(at: 9,
                                                                       ofType: AISLongRange.ShipType.self,
                                                                       optional: true)
            }
        }
        ...
        var length: Measurement<UnitLength>? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.measurement(at: 7,
                                                                       valueType: .float,
        ...
        var breadth: Measurement<UnitLength>? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.measurement(at: 8,
                                                                       valueType: .float,
                                                                       units: UnitLength.meters,
                                                                       optional: true)
            }
        ...
        var draught: Measurement<UnitLength>? {
            get throws {
                try sentences[.AISLongRangeReply3]?.fields.measurement(at: 5,
                                                                       valueType: .float,
                                                                       units: UnitLength.meters,
                                                                       optional: true)
            }
        ...
        init?(sentence: ParametricSentence) throws {
            switch sentence.format {
                case .AISLongRangeFunction:
                    let functions = try LRFunctions(fields: sentence.fields)
                    formats = .init([.AISLongRangeFunction] + functions.compactMap { Self.functionFormats[$0] })
...
private func LRFunctionReplies(fields: Fields) throws -> [AISLongRange.FunctionStatus] {
    ...
    return try replyStr.map { char in
        guard let rawValue = Int(String(char)),
              let status = AISLongRange.FunctionStatus(rawValue: rawValue) else {
            throw fields.fieldError(type: .badCharacterValue, index: 2)
        }
        return status
    }
