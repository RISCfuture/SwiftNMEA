  ...
  private struct LRIElement: BufferElement {
    ...
    var replyLogic: AISLongRange.ReplyLogic? {
      get throws {
        try sentences[.AISLongRangeInterrogation]?.fields.enumeration(
          at: 1, ofType: AISLongRange.ReplyLogic.self)
      }
    }
    ...
    var destination: AISLongRange.Destination? {
      get throws {
        ...
        if let northeast = try sentence.fields.position(
          latitudeIndex: (4, 5), longitudeIndex: (6, 7), optional: true),
          let southwest = try sentence.fields.position(
            latitudeIndex: (8, 9), longitudeIndex: (10, 11), optional: true)
        {
