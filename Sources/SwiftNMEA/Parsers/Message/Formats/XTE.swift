...
class XTEParser: MessageFormat {
    ...
    func parse(sentence: ParametricSentence) throws -> Message.Payload? {
        let blink = try sentence.fields.bool(at: 0, trueValue: "V", falseValue: "A")!,
            cycleLock = try sentence.fields.bool(at: 1, trueValue: "V", falseValue: "A")!,
            ...
            mode = try sentence.fields.enumeration(at: 5, ofType: Navigation.Mode.self)!

        return .crossTrackError(isLeft ? xte * -1 : xte,
                                mode: mode,
