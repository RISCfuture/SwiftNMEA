...
final class TimeParser {
  ...
  func hmsDecimalComponents(_ value: String, timeZone: TimeZone = .gmt) throws -> DateComponents? {
    ...
    return .init(
      calendar: calendar, timeZone: timeZone, hour: hour, minute: minute, second: Int(intSecond),
  ...
  func hmsComponents(_ value: String, timeZone: TimeZone = .gmt) throws -> DateComponents? {
    ...
    return .init(
      calendar: calendar, timeZone: timeZone, hour: hour, minute: minute, second: Int(second))
  }

  func parseHmsDecimal(
    _ value: String, searchDirection: Calendar.SearchDirection, referenceDate: Date = .now,
