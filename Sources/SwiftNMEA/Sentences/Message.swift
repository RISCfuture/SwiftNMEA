...
public struct Message: Element, Sendable, Codable, Equatable {
  ...
  public enum Payload: Sendable, Codable, Equatable {
    ...
    case GNSSRangeResiduals(
      _ residuals: [GNSS.SatelliteID: Measurement<UnitLength>], time: Date, recomputed: Bool)
    ...
    case headingSteeringCommand(
      headingTrue: Bearing, headingMagnetic: Bearing, status: SentenceType)
    ...
    case waypointClosure(
      _ closure: Measurement<UnitSpeed>, identifier: String, mode: Navigation.Mode)
    ...
    case timeDistanceToVariablePoint(
      time: Duration, distance: Measurement<UnitLength>, type: Navigation.VariablePoint)
