    ...
    public enum ShipType: RawRepresentable, Sendable, Codable, Equatable {
        ...
        public var rawValue: Int {
            switch self {
                ...
                case let .groundEffect(cargo): return 20 + cargo.rawValue
                case let .vessel(operation): return 30 + operation.rawValue
                case let .highSpeedCraft(cargo): return 40 + cargo.rawValue
                case let .passengerShip(cargo): return 60 + cargo.rawValue
                case let .cargoShip(cargo): return 70 + cargo.rawValue
                case let .tanker(cargo): return 80 + cargo.rawValue
                case let .other(cargo): return 90 + cargo.rawValue
            }
        }
