      ...
      it("parses a sentence") {
        ...
        guard
          case .autopilotSentenceB(
            let LORANC_blinkSNRFlag, let LORANC_cycleLockWarningFlag, let crossTrackError,
            let arrivalCircleEntered, let perpendicularPassed, let bearingOriginToDest,
            let destinationID, let bearingPresentPosToDest, let headingToDest, let mode) = payload
        else {
