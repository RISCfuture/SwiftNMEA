    ...
    describe("8.3.16 BWC") {
      it("parses a sentence") {
        ...
        let sentence = createSentence(
          delimiter: .parametric, talker: .integratedNavigation,
          format: .bearingDistanceToWaypointGC,
          fields: [
        ...
        guard
          case .bearingDistanceToWaypointGC(
            let observationTime, let waypointPosition, let bearingTrue, let bearingMagnetic,
            let distance, let waypointID, let mode) = payload
        else {
