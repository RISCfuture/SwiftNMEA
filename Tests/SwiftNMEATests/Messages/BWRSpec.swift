            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    ...
                    sentence = createSentence(
                        delimiter: .parametric, talker: .integratedNavigation, format: .bearingDistanceToWaypointRL,
                ...
                guard case let .bearingDistanceToWaypointRL(observationTime, waypointPosition, bearingTrue, bearingMagnetic, distance, waypointID, mode) = payload else {
