            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .depthSounder, format: .currentWaterLayer,
                        fields: ["A", 2, 3,
                                 3.5,
                                 120.5, "R",
                                 11.2,
                ...
                guard case let .currentWaterLayer(isValid, setNumber, layer, depth, direction, speed, referenceDepth, heading, speedReference) = payload else {
