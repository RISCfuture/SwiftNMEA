  ...
  override static func spec() {
    describe("8.3.25 DSC") {
      it("parses the distress example from the spec") {
        ...
        guard
          case .DSC(
            let format, let MMSI, let area, let category, let message1_1, let message1_2,
            let message2, let message3, let distressMMSI, let distressMMSINature,
            let acknowledgement, let expansion) = payload
        else {
      ...
      it("parses the relay example from the spec") {
        ...
        guard
          case .DSC(
            let format, let MMSI, let area, let category, let message1_1,
            let
              message1_2, let message2, let message3, let distressMMSI,
            let
              distressMMSINature, let acknowledgement,
            let
              expansion) = message.payload
        else {
