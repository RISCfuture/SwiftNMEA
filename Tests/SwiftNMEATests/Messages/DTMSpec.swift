            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .GNSS, format: .datumReference,
                        fields: ["999", "F",
                                 "13.2", "N",
                                 "22.8", "W",
                                 "-12.5",
                ...
                guard case let .datumReference(localDatum, latitudeOffset, longitudeOffset, altitudeOffset, referenceDatum) = payload else {
