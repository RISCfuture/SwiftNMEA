      ...
      it("parses a sentence") {
        ...
        guard
          case .GNSSAccuracyIntegrity(
            let actualTime, let HPL, let VPL, let semimajorStddev, let semiminorStddev,
            let semimajorErrorOrientation, let altitudeStddev, let selectedAccuracy, let integrity) =
            payload
        else {
