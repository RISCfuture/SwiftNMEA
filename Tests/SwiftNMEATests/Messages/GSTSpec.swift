      ...
      it("parses a sentence") {
        ...
        guard
          case .GNSSPseudorangeNoise(
            let actualTime, let rangeStddevRMS, let errorSemimajorStddev, let errorSemiminorStddev,
            let errorOrientation, let errorLatitudeStddev, let errorLongitudeStddev,
            let errorAltitudeStddev) = payload
        else {
