            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .integratedInstrumentation, format: .headingMonitorReceive,
                        fields: ["HDG1", "HDG2",
                                 5.0, 6.0, "V",
                                 96.2, "A", "M", 6.5, "E",
                                 90.2, "V", "T", nil, nil,
                ...
                guard case let .headingMonitorReceive(sensor1, sensor2, setDifference, difference, differenceOK, variation) = payload else {
