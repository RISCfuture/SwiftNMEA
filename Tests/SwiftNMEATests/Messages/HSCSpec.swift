            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .integratedInstrumentation, format: .headingSteeringCommand,
                ...
                guard case let .headingSteeringCommand(headingTrue, headingMagnetic, status ) = payload else {
