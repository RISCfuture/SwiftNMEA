        ...
        it("parses a sentence") {
          ...
          guard
            case .AISLongRangeReply(
              let requestorMMSI, let requestorName, let replyStatuses, let actualFixTime,
              let
                shipName, let shipCallsign, let shipIMO, let position, let course,
              let
                speed, let destination, let actualETA, let shipType, let shipType2, let length,
              let
                breadth, let draught, let soulsOnboard) = payload
          else {
          ...
          guard
            case .AISLongRangeReply(
              ...
              let
                speed, let destination, let actualETA, let shipType, let shipType2, let length,
              let
                breadth, let draught, let soulsOnboard) = message.payload
          else {
