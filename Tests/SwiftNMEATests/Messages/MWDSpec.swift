            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .commDataReceiver, format: .windDirectionSpeed,
                        fields: [225.0, "T", 220.0, "M",
                                 12.5, "N", 6.43, "M"]),
                ...
                guard case let .windDirectionSpeed(directionTrue, directionMagnetic, speedKnots, speedMps) = payload else {
