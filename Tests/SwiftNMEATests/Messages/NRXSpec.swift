    ...
    describe("8.3.63 NRX") {
      describe(".parse") {
        it("parses the example sentence group") {
          ...
          guard
            case .NAVTEXMessage(
              let message, let id, let frequency, let code, let time, let totalCharacters,
              let badCharacters, let isValid) = payload
          else {
          ...
          let components = DateComponents(
            timeZone: .gmt, year: 2001, month: 6, day: 27, hour: 13, minute: 56, second: 0)
      ...
      describe(".flush") {
        it("flushes incomplete sentences") {
          ...
          guard
            case .NAVTEXMessage(
              let message, let id, let frequency, let code, let time, let totalCharacters,
              let badCharacters, let isValid) = message.payload
          else {
