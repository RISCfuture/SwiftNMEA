      ...
      it("parses a sentence") {
        ...
        guard
          case .destinationMinimumData(
            let isValid, let crossTrackError, let originID, let destinationID, let destination,
            let rangeToDestination, let bearingToDestination, let closingVelocity, let isArrived,
            let mode) = payload
        else {
