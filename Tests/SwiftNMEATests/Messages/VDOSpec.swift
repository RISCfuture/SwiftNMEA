    ...
    describe("8.3.91 VDO") {
      describe(".parse") {
        ...
        it("parses a 62-character (46-byte) sentence when some fields are nil") {
          ...
          let sentence = createSentence(
            delimiter: .encapsulated, talker: .commVHF, format: .VDLOwnshipReport,
          ...
          guard case .VDLOwnshipReport(let actualData, let channel) = payload else {
      ...
      describe(".flush") {
        it("flushes incomplete sentences") {
          ...
          guard case .VDLOwnshipReport(let message, let channel) = message.payload else {
