    ...
    describe("8.3.93 VER") {
      describe(".parse") {
        it("parses a sentence") {
          ...
          guard
            case .version(
              let type, let vendorID, let uniqueID, let serialNumber, let modelCode,
              let softwareRevision, let hardwareRevision) = payload
          else {
      ...
      describe(".flush") {
        it("flushes incomplete sentences") {
          ...
          guard
            case .version(
              let type, let vendorID, let uniqueID, let serialNumber, let modelCode,
              let softwareRevision, let hardwareRevision) = message.payload
          else {
