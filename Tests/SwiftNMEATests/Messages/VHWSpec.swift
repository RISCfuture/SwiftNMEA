            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .integratedNavigation, format: .waterSpeedHeading,
                ...
                guard case let .waterSpeedHeading(bearingTrue, magnetic, speedKnots, speedKph) = payload else {
