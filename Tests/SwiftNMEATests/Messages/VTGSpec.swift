            ...
            it("parses a sentence") {
                let parser = SwiftNMEA(),
                    sentence = createSentence(
                        delimiter: .parametric, talker: .integratedNavigation, format: .groundSpeedCourse,
                        fields: [123.4, "T", 124.5, "M",
                                 12.3, "N", 23.4, "K",
                                 "A"]),
                ...
                guard case let .groundSpeedCourse(courseTrue, courseMagnetic, speedKnots, speedKph, mode) = payload else {
