        ...
        describe("Query") {
            describe("rawValue") {
                it("encodes a sentence") {
                    let query = Query(requester: .GPS, recipient: .commDataReceiver, format: .MSKReceiverSignalStatus)
            ...
            describe("parsing") {
                it("parses a sentence from a STA8089FG") {
                    let parser = SwiftNMEA(),
                        sentence = "$PSTMPVRAW,235943.070,9000.00000,N,00000.00000,E,0,00,0.0,-6356752.31,M,0.0,M,nan,nan,nan*33\r\n",
                    ...
                    expect(message.data).to(equal("PVRAW,235943.070,9000.00000,N,00000.00000,E,0,00,0.0,-6356752.31,M,0.0,M,nan,nan,nan"))
                }
            }
        }
    }
